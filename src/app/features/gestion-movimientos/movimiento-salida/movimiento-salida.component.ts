  ...
  template: `
    <div class="form-container">
      <div class="form-header">
        <h2>Registrar Salida de Stock (Venta)</h2>
        <p class="subtitle">Registra la salida o venta de mercadería de una sucursal del sistema.</p>
      </div>
        ...
        <form [formGroup]="salidaForm" (ngSubmit)="onSubmit()">
          <div class="form-grid">
            ...
            <div class="form-group">
              <label for="sucursalId">Sucursal de Origen</label>
              <select
                id="sucursalId"
            ...
            <!-- Cantidad -->
            <div class="form-group">
              <label for="cantidad">Cantidad a Vender / Retirar</label>
              <input
                type="number"
                id="cantidad"
            ...
            <!-- Observación -->
            <div class="form-group col-span-2">
              <label for="observacion">Observación / Nota de Venta</label>
              <textarea
                id="observacion"
                formControlName="observacion"
                placeholder="Ej. Venta al público en caja principal, regularización por merma..."
